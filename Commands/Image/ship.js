...
module.exports = {
    name: "ship",
    usage: ["Do you ship two people? Add their profile URL's here```{prefix}ship <imageurlUser1> <imageurlUser2>```"],
    enabled: true,
    aliases: ["love"],
    ...
    async execute(client, message, args, data){
        try{
            ...
            const res = await fetch(`https://nekobot.xyz/api/imagegen?type=ship&user1=${imageurl1}&user2=${imageurl2}`);
